...
- State JSON has 4 MiB, depth, element-count, and 512-profile limits; duplicate and unknown properties are rejected before linear-time semantic validation of non-empty unique profile IDs/logins, safe names, colours, paths, selections, and deletion markers.
- Friendly-name edits and independent play-account selection are persisted transactionally; message/notification-title content is never included in state.
